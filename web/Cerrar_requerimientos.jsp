    ...
    <body>
        ...
        <form action="controlador" method="post">
            ...
            <table border="5" class="ancho">
                ...
                <!aqui agregara una fila si eligieron los parametros anteriores y se apreto el boton el cual traera la 
                variable query1 con una consulta de controlador la cual es verificada segun seleccion
                usa la consulta concatenada en base a la busqueda seleccionada>
            <%  
            try{
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/requerimiento?zeroDateTimeBehavior=convertToNull","root","");
            ...
            <!muestra los registros de las columnas y se le agregara un form el cual se creara para cada 
            registro se asignara acto>
            ...
            <tr>
                ...
                <!aqui pregunta por los requerimientos en estado abierto si lo estan mostrala el boton con un un acto y parametro codigo para
                    identificar el requerimiento y usar ese codigo unico para cerrar el estado del requerimiento
                    en caso contrario no mostrara ningun boton al ya estar cerrado>
